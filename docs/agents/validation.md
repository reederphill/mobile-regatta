...
| 3 | golden / RegattaBots rows | CI Linux job log | a sim change needs a new row: take `GOLDEN …` and `REGATTABOTS …` from the log and commit the row last, after review (no local podman since 2026-09-25) |
