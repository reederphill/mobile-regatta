...
- Bots' inputs are logged exactly like players' inputs, and a replay never re-runs a bot brain. Bots can be retuned without bumping the simulation version (settled in [Netcode and authority model](https://github.com/reederphill/mobile-regatta/issues/18)).
